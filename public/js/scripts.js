...
function construirDiv(produto, id, valor) {
  ...
  elementoQuantidade.setAttribute(
    "onkeyup",
    "atualizaSubTotal(this.value,this.id)"
  );
...
function inserirUltimosSeteDias() {
  return (document.getElementById("datetime").value = moment()
    .subtract("7", "days")
    .format("YYYY-MM-DD"));
}
...
function inserirPrimeiroDiaMes() {
  return (document.getElementById("datetimeinital").value =
